...
def main():
    for channel, averages in channels.items():
        ...
        old_signal_df = pd.read_csv('C:/Users/carter/Documents/crypto/peter-signal/data/signals/' + channel + '.csv')
        ...
        if len(new_signals) > 0:
            ...
            old_signal_df.to_csv('C:/Users/carter/Documents/crypto/peter-signal/data/signals/' + channel + '.csv', index=False)
